=================================================================
|icon| Sale Commission Formula/Provvisioni con formula 10.0.1.0.2
=================================================================

**Sale commissions computed by formulas**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/commission/10.0/sale_commission_formula/static/description/icon.png
...
|en| This module extends sale_commission to introduce the use of formulas to
compute the agent commissions.


|it| Questo modulo estende le funzionalità del modulo provvigioni
e permette di callcolare le provvigioni tramite formule.


|thumbnail|

.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/commission/10.0/sale_commission_formula/static/description/description.png
...
* [QUA] Test coverage 86% (22: 3+19) [0 TestPoints] - quality rating 52 (target 100)
