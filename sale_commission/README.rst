...
::
    ...
    odoo_install_repository commission -b 10.0 -O zero -o $HOME/10.0
...
::
    ...
    odoo_install_repository commission -b 10.0 -o $HOME/10.0 -U
...
.. |Build Status| image:: https://travis-ci.org/zeroincombenze/commission.svg?branch=10.0
    :target: https://travis-ci.com/zeroincombenze/commission
    :alt: github.com
